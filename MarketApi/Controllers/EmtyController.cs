...
namespace MarketApi.Controllers
{
    public class EmtyController : ApiController
    {
        ...
        public HttpResponseMessage Get(string name = "All", string n = "All")
        {
        ...
        public HttpResponseMessage Get(string id)
        {
                ...
                if (entity == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.NotFound, "Costomar with Id = " + id + " Not Fond");
                }
                else
                {
        ...
        public HttpResponseMessage Put(string id, [FromBody]UserT TBUser)
        {
            try
            {
